...
public class _Function {
    public static void main(String[] args) {
        ...
        Function<Integer, Integer> incrementByOnAndThenMultipleByTen = incrementByOneFunction.andThen(multipleByTenFunction);
    ...
    // BiFunction<Input1, Input2, Output> functionName = (Parameter1, Parameter2) -> Logic
    private static BiFunction<Integer, Integer, Integer> incrementFirstNumberAndMultipleWithSecondNumberFunction = (number1, number2) -> (number1 + 1) * number2;
